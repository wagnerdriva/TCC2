...
val_ds = val_ds.prefetch(buffer_size=32)
 ...
 # Use pre-trained InceptionResNetV2 model
base_model = InceptionResNetV2(weights=None, include_top=False, input_shape=image_size + (3,))
...
checkpoint = ModelCheckpoint("models/InceptionResNetV2-HATCH-{epoch:02d}-{val_loss:.2f}-{val_categorical_accuracy:.2f}.hdf5", monitor='val_loss', verbose=1, save_best_only=True, mode='auto')
...
model.save("models/finalInceptionResNetV2-HATCH-Test.hdf5")
...
plt.legend()
plt.savefig('images/LossVal_lossInceptionResNetV2-HATCH.png')
...
plt.legend()
plt.savefig('images/AccVal_accInceptionResNetV2-HATCH.png')
