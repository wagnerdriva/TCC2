...
val_ds = val_ds.prefetch(buffer_size=32)
 ...
 # Use pre-trained EfficientNetB3 model
...
checkpoint = ModelCheckpoint("models/EfficientNetB3-{epoch:02d}-{val_loss:.2f}-{val_categorical_accuracy:.2f}.hdf5", monitor='val_loss', verbose=1, save_best_only=True, mode='auto')
...
model.save("models/finalEfficientNetB3-Final.hdf5")
...
plt.legend()
plt.savefig('images/LossVal_lossEfficientNetB3.png')
...
plt.legend()
plt.savefig('images/AccVal_accEfficientNetB3.png')
